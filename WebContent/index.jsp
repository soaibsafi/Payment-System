...
<body>
	<div id="outer">
				...
				<tr>
					<td><div>
							<marquee direction="up" width="300px" truespeed="truespeed"
								...
								Date of fee Submission is 15/10/12 After that You'll have to pay
								100 BDT per day as a fine and your tuition fee exclusively </marquee>
						</div></td>
				</tr>
			</table>
			<center>
		...
		<div id="header">
			<h4>
				Copyright 2012 All rights reserved.fore more information please
				visit: <a href="www.soaibsafi.com"><font style="color: yellow;">www.soaibsafi.com</font></a>
			</h4>
		</div>
